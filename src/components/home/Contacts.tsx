      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="mx-auto shadow-lg bg-white p-14 max-w-[1000px] rounded-xl flex flex-col items-center justify-center md:flex-row gap-6">
          <div className="md:w-1/2 w-full">
            <h1 className="flex-1 text-2xl font-bold leading-relaxed">
          ...
          <div className="md:w-1/2 w-full flex flex-col gap-4">
            ...
            <div>
              <h2 className="text-base font-semibold">Info@icinvest.ru</h2>
              <p className="text-sm text-gray-9">Пишите</p>
            </div>
            <div>
              <h2 className="text-base font-semibold">8 (3652) 67 41 00</h2>
